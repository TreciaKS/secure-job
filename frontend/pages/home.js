...
const HomePage = () => {
  return (
    <div>
        <div className="relative flex flex-col-reverse h-screen py-8 lg:pt-12 lg:flex-col lg:pb-0">
        ...
        <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <q className="inline-block py-px mb-4 font-semibold tracking-wider text-indigo-500 capitalize rounded-full text-md bg-teal-accent-400">
